...
const ReceiptModal: React.FC = () => {
    ...
    const { shopSettings, offlineReceiptLogo, offlineReceiptPromo, handleManualDrawerOpen, dailyData } = useData();
                ...
                <div className="receipt-preview">
                    <div id="printable-receipt" className={`receipt-paper receipt-${receiptWidth}`} style={receiptStyles}>
                        <div className="receipt-header-content">
                            <img
                                src={offlineReceiptLogo || shopSettings.logoUrl}
                                alt="Shop Logo"
                        ...
                        <div className="receipt-footer">
                            ...
                            <img
                                src={offlineReceiptPromo || shopSettings.promoUrl}
                                alt="Promo"
